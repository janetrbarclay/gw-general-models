...
model_dict['CoastalCT500'] = {'ws':'CoastalCT500','vpu':'NHDPlusNE_MA/NHDPlus01_02','rpu':'ned01a_02b','df':'CoastalCT_domain.shp', 'ib_filter':0, 'K_bedrock':1 * ft2m, 'zone_src': 'PriorityEmbayments.shp', 'sewer_src': 'CoastalCT_Sewer.shp', 'pws_src': 'CoastalCT_WaterSupply.shp', 'well_src':'PWS_well_estimates.shp', 'saltwater_src':'CoastalBoundary.shp', 'bedrock_geo':"BedrockGeology.shp", 'surf_geo':"LISS_SurficialGeology.shp",'wetlands_src':"CoastalBoundaryWetland.tif",'soil_src':"PerSand_60to200cm.tif","L":500*ft2m}
model_dict['CoastalCT'] = {'ws':'CoastalCT','vpu':'NHDPlusNE_MA/NHDPlus01_02','rpu':'ned01a_02b','df':'CoastalCT_domain.shp', 'ib_filter':0, 'K_bedrock':1 * ft2m, 'zone_src': 'PriorityEmbayments.shp', 'sewer_src': 'CoastalCT_Sewer.shp', 'pws_src': 'CoastalCT_WaterSupply.shp', 'well_src':'PWS_well_estimates.shp', 'saltwater_src':'CoastalBoundary.shp', 'bedrock_geo':"BedrockGeology.shp", 'surf_geo':"LISS_SurficialGeology.shp",'wetlands_src':"CoastalBoundaryWetland.tif",'soil_src':"PerSand_60to200cm.tif"}
model_dict['Niantic'] = {'ws':'Niantic','vpu':'NHDPlusNE_MA/NHDPlus01_02','rpu':'ned01a_02b','df':'Niantic_domain.shp', 'ib_filter':0, 'K_bedrock':1 * ft2m, 'zone_src': 'PriorityEmbayments.shp', 'sewer_src': 'CoastalCT_Sewer.shp', 'pws_src': 'CoastalCT_WaterSupply.shp', 'well_src':'PWS_well_estimates.shp', 'saltwater_src':'CoastalBoundary.shp', 'bedrock_geo':"BedrockGeology.shp", 'surf_geo':"LISS_SurficialGeology.shp",'wetlands_src':"CoastalBoundaryWetland.tif",'soil_src':"PerSand_60to200cm.tif"}
model_dict['Niantic500'] = {'ws':'Niantic500','vpu':'NHDPlusNE_MA/NHDPlus01_02','rpu':'ned01a_02b','df':'Niantic500_domain.shp', 'ib_filter':0, 'K_bedrock':1 * ft2m, 'zone_src': 'PriorityEmbayments.shp', 'sewer_src': 'CoastalCT_Sewer.shp', 'pws_src': 'CoastalCT_WaterSupply.shp', 'well_src':'PWS_well_estimates.shp', 'saltwater_src':'CoastalBoundary.shp', 'bedrock_geo':"BedrockGeology.shp", 'surf_geo':"LISS_SurficialGeology.shp",'wetlands_src':"CoastalBoundaryWetland.tif",'soil_src':"PerSand_60to200cm.tif","L":500*ft2m}
model_dict['Niantic250'] = {'ws':'Niantic250','vpu':'NHDPlusNE_MA/NHDPlus01_02','rpu':'ned01a_02b','df':'Niantic250_domain.shp', 'ib_filter':0, 'K_bedrock':1 * ft2m, 'zone_src': 'PriorityEmbayments.shp', 'sewer_src': 'CoastalCT_Sewer.shp', 'pws_src': 'CoastalCT_WaterSupply.shp', 'well_src':'PWS_well_estimates.shp', 'saltwater_src':'CoastalBoundary.shp', 'bedrock_geo':"BedrockGeology.shp", 'surf_geo':"LISS_SurficialGeology.shp",'wetlands_src':"CoastalBoundaryWetland.tif",'soil_src':"PerSand_60to200cm.tif","L":250*ft2m}
