...
model_dict['CoastalCT'] = {'ws':'CoastalCT','vpu':'NHDPlusNE_MA/NHDPlus01_02','rpu':'ned01a_02b','df':'CoastalCT_domain.shp', 'ib_filter':0, 'K_bedrock':1 * ft2m, 'zone_src': 'LIS_WS_EMBAY_DISS.shp', 'sewer_src': 'CoastalCT_Sewer.shp', 'pws_src': 'CoastalCT_WaterSupply.shp', 'well_src':'PWS_well_estimates.shp', 'saltwater_src':'CoastalBoundary.shp', 'bedrock_geo':"BedrockGeology.shp", 'surf_geo':"LISS_SurficialGeology.shp",'wetlands_src':"CoastalBoundaryWetland.tif"}
